            ...
            <Alert>
              ...
              <AlertDescription>
                <div className="flex items-center justify-between">
                  <span>
                    Successfully loaded financial information from {fileName}. The AI can now provide personalized
                    advice based on your complete financial database with full historical data preservation.
                  </span>
                </div>
              </AlertDescription>
            </Alert>
